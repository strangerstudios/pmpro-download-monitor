# Contribute to Paid Memberships Pro - Download Monitor Integration

Paid Memberships Pro - Download Monitor Integration protects downloads for members only and charge for access to downloadable files using Download Monitor and Paid Memberships Pro.
...
* Submit a ticket for your issue, assuming one does not already exist.
  * Raise it on our [Issue Tracker](https://github.com/strangerstudios/pmpro-download-monitor/issues/)
...
* For bug fixes, checkout the DEV branch of the Download Monitor Integration repository.
...
* Make sure to pull in any "upstream" changes first.
	* Use `git remote add upstream https://github.com/strangerstudios/pmpro-pmpro-download-monitor.git` to set the upstream repo
...
* For bug fixes, submit a pull request to the DEV branch of the Download Monitor Integration repository.
